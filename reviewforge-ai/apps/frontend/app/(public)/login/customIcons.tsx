...
export function ReviewForgeIcon(props: SvgIconProps) {
  return (
    <SvgIcon {...props} viewBox="0 0 64 64">
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#101B5C" />
          <stop offset="1" stopColor="#2836C7" />
        </linearGradient>

        <linearGradient
          id="reviewforge-accent"
          x1="28"
          y1="22"
          x2="52"
          y2="48"
        ...
        >
          ...
          <stop offset="1" stopColor="#A43CFF" />
        </linearGradient>
      </defs>
      ...
      <path
        d="
          M32 3
          C34.5 3 36.2 4 38.2 5.2
          L54 14.5
          C57 16.3 59 19.5 59 23
          V41
          C59 44.5 57 47.7 54 49.5
          L38.2 58.8
          C36.2 60 34.5 61 32 61
          C29.5 61 27.8 60 25.8 58.8
          L10 49.5
          C7 47.7 5 44.5 5 41
          V23
          C5 19.5 7 16.3 10 14.5
          L25.8 5.2
          C27.8 4 29.5 3 32 3
          Z
        "
        fill="url(#reviewforge-bg)"
      />
      ...
      <path
        d="
          ...
          L18 33
          H29
          C32.5 33 34.5 31.5 34.5 29
          C34.5 26.5 32.5 25 29 25
          H18
          Z
        "
        fill="white"
      ...
      <path
        d="
          M35 32
          H52
          C51.5 35 49.5 37 46.5 37
          H39
          L37.5 41
          H47
          C46.5 44 44.5 46 41.5 46
          H36
          L34 52
          H28
          Z
        "
        fill="url(#reviewforge-accent)"
      />
      ...
      <path
        d="
          M47 12
          C47.8 15.2 49 16.4 52 17
          C49 17.7 47.8 19 47 22
          C46.2 19 45 17.7 42 17
          C45 16.4 46.2 15.2 47 12
          Z
        "
        fill="#9A6BFF"
      />
      ...
      <path
        d="
          M53 21
          C53.4 22.7 54.2 23.5 56 24
          C54.2 24.5 53.4 25.3 53 27
          C52.6 25.3 51.8 24.5 50 24
          C51.8 23.5 52.6 22.7 53 21
          Z
        "
        fill="#6176FF"
      />
      ...
      <path
        d="
          M48 25
          C48.4 26.7 49.2 27.5 51 28
          C49.2 28.5 48.4 29.3 48 31
          C47.6 29.3 46.8 28.5 45 28
          C46.8 27.5 47.6 26.7 48 25
          Z
        "
        fill="#387DFF"
      />
